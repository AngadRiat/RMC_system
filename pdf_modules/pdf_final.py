...
if invoice_data["buyer_state"]=="west bengal":
    invoice_data["sgst"] = "9"
    invoice_data["cgst"] = "9"
    invoice_data["sgst_amount"] = "11,880.00"
    invoice_data["cgst_amount"] = "11,880.00"
...
def pdf_generate_new(invoice_data):
    ...
    for position in tick_positions:
        ...
        draw_wrapped_text(c, 35, 655, invoice_data["buyer_details"], box_width=240, default_box_height=58, max_box_height=58)
        draw_wrapped_text(c, 305, 655, invoice_data["consignee_details"], box_width=240, default_box_height=58, max_box_height=58)
        ...
        for i, item in enumerate(invoice_data["goods"], start=1):
            ...
            description_height = draw_wrapped_text(
                ...
                box_width=200, default_box_height=default_description_height,
        ...
        c.showPage()  # Saves the current page, so the next one starts fresh
...
data = pdf_generate_new(invoice_data)